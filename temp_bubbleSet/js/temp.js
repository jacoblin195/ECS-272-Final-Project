        ...
        var timer = setInterval(function() {
            ...
            if(stop == 1) {
                ...
                if(continent == "Asia"){
                    ...
                    for(var j=0;j<len;j++){
                        if(xs[j] != -1 && ys[j] != -1) {
                            addRect(rectanglesA, "blue", xs[j], ys[j],continent);
                        }
                    }
                }
                    ...
                    for(var j=0;j<len;j++){
                        if(xs[j] != -1 && ys[j] != -1) {
                            addRect(rectanglesC, "green", xs[j], ys[j],continent);
                        }
                    }
                }
                    ...
                    for(var j=0;j<len;j++){
                        if(xs[j] != -1 && ys[j] != -1) {
                            addRect(rectanglesD, "red", xs[j], ys[j],continent);
                        }
                    }
                }
                    ...
                    for(var j=0;j<len;j++){
                        if(xs[j] != -1 && ys[j] != -1) {
                            addRect(rectanglesE, "black", xs[j], ys[j],"NorthAmerica");
                        }
                    }
                }
            }
